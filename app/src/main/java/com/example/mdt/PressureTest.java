...
public class PressureTest extends AppCompatActivity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        pressureSensorText.setText("Pressure = " + String.valueOf(currentValue) + " hPa");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //retrieve widget
        pressureSensorText = findViewById(R.id.text1);
